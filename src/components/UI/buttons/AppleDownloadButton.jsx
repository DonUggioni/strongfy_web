...
function AppleDownloadButton({ onClick }) {
  return (
    <button
      onClick={onClick}
      className='flex flex-row items-center justify-center gap-2 text-textColor border-2 rounded border-textColor pr-3  hover:border-primary400 transition-all shadow-sm hover:shadow-primary400/50 sm:pl-4 sm:pr-6 sm:py-1'
    >
