...
function TermsModalContent() {
  return (
    <div className='text-textColor'>
      ...
      <p>Welcome to Barbell Hub!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Barbell Hub's Website, located at www.barbell-hub.com.
      </p>
      <p>
        By accessing this website, we assume you accept these terms and
        conditions. Do not continue to use Barbell Hub if you do not agree to
      ...
      <p>
        ...
        accessing Barbell Hub, you agreed to use the required cookies.
      </p>
      <p>
      ...
      <h2>License:</h2>
      <p>
        Unless otherwise stated, Barbell Hub and/or its licensors own the
        intellectual property rights for all material on Barbell Hub. All
        intellectual property rights are reserved. You may access this from
        Barbell Hub for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Copy or republish material from Barbell Hub</li>
        <li>Sell, rent, or sub-license material from Barbell Hub</li>
        <li>Reproduce, duplicate or copy material from Barbell Hub</li>
        <li>Redistribute content from Barbell Hub</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer users an opportunity to post and exchange
        opinions and information in certain areas of the website. Barbell Hub
        does not filter, edit, publish or review Comments before their presence
        on the website. Comments do not reflect the views and opinions of
        Barbell Hub, its agents, and/or affiliates. Comments reflect the views
        and opinions of the person who posts their views and opinions. To the
        extent permitted by applicable laws, Barbell Hub shall not be liable for
      ...
      <p>
        Barbell Hub reserves the right to monitor all Comments and remove any
      ...
      <p>
        You hereby grant Barbell Hub a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        e-mail to Barbell Hub. Please include your name, your organization name,
      ...
      <p>
        No use of Barbell Hub's logo or other artwork will be allowed for
